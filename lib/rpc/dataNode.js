...
var DataNode = /** @class */ (function (_super) {
    ...
    function DataNode(host, getWidgetCommunication, config) {
        ...
        _this.getUnSettles = function (address) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.post(method_1.METHOD.getUnSettles, [
                            address,
                        ])];
                    case 1:
                        rest = _a.sent();
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        blk = {
                            ...
                            parent_hash: (0, emit_lib_1.getDefaultHash)(),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.post(method_1.METHOD.prepareBlock, [signData.result])];
                    case 3:
                        rest = _a.sent();
