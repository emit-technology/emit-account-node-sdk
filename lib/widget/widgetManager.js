...
var WidgetManager = /** @class */ (function () {
    ...
    WidgetManager.prototype.requestAccount = function (accountId) {
        return __awaiter(this, void 0, void 0, function () {
            var widgetCommunication;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        widgetCommunication = (_a.sent()).communication;
                        return [2 /*return*/, widgetCommunication.requestAccount(this._widgetConfig, accountId)];
                }
            });
        });
    };
    WidgetManager.prototype.setLanguage = function (code) {
        return __awaiter(this, void 0, void 0, function () {
            var widgetCommunication;
            return __generator(this, function (_a) {
                switch (_a.label) {
