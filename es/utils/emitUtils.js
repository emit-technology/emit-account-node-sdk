...
var EmitUtils = /** @class */ (function () {
    function EmitUtils() {
        ...
        this.fromValue = function (v, decimal) {
            ...
            return new BigNumber(new BN(v, "hex", "be").toString()).dividedBy(Math.pow(10, decimal));
        };
        this.formatValue = function (v, decimal) {
            if (decimal === void 0) { decimal = 18; }
            return _this.nFormatter(new BigNumber(new BN(v, "hex", "be").toString()).dividedBy(Math.pow(10, decimal)), 5);
        };
