...
export async function getTxGas(query: IQuery, txParams: any) {
...
async function safeTxGas(query: IQuery, txParams: TxParams, blockGasLimitHex: GasHex) {
...
async function estimateTxGas(query: IQuery, txParams: TxParams, blockGasLimitHex: GasHex, safeGas: GasHex) {
